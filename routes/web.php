...
Route::middleware('admin')->group(function(){
    ...
    Route::get('/edit_product/{product}/edit', [ProductController::class, 'edit_product'])->name('edit_product');
    ...
    Route::post('/order/{order}/confirme', [OrderController::class, 'confirme_payment'])->name('confirme_payment');
});

Route::middleware('auth')->group(function (){
    Route::get('/product/{product}', [ProductController::class, 'show_product'])->name('show_product');
    Route::post('/product/{product}', [CartController::class, 'add_to_cart'])->name('add_to_cart');
